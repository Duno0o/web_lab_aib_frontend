...
![alt](images/task1.png) ![alt](images/task11.png)
 #### Задание №2. создать список постов пользоваталей, пост должен принимать имя пользователя, текст в посте, так же добавить возможность лайкать посты и визуально показывать лайкнутый пост
Файл App.js
```shell
import './App.css';
import React, { useState } from 'react';
...
```
![alt](images/task4.png) ![alt](images/task41.png)![alt](images/task412.png) 
